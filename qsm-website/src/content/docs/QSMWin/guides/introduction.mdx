...
beginners. The software can be downloaded through [GitHub Releases](https://github.com/lines-of-codes/QSMSharp/releases).

You can simply extract the `.zip` file and run the file named `QSM.Windows.exe`.
