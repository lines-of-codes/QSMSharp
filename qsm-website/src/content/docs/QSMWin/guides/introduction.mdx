...
<Aside>
    QSM.Windows is now in maintenance mode. It will receive bugfixes but not 
    new features from the maintainer. However, new pull requests with new 
    features will still be accepted.
</Aside>
